            ...
            const days=weatherData.daily.map((day,index)=>{
                ...
                return(
                        <div key={index}  className="weekday">
                            <div style={{background: dayTime ? (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#F3F3F3' : '#FAFAFA') : (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#72879C' : '#8FA1B1')}} className="day">
                                <div> <span>{moment(date).format('ddd')}</span></div>
                                <div className="date"> <span>{moment(date).format('M/D')}</span> </div>
                            </div>
                            <div style={{background: dayTime ? (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#F3F3F3' : '#FAFAFA') : (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#72879C' : '#8FA1B1')}} className="daydescription">
                                <div> <span>{day.weather[0].description}</span></div>
                            </div>
                            <div style={{background: dayTime ? (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#F3F3F3' : '#FAFAFA') : (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#72879C' : '#8FA1B1')}} className="weathericon">
                                <img className="dayweatherimage" src={`http://openweathermap.org/img/wn/${day.weather[0].icon}@2x.png`} alt=""/>
                            </div>
                            <div style={{background: dayTime ? (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#F3F3F3' : '#FAFAFA') : (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#72879C' : '#8FA1B1')}} className="daytemperature">
                                <span>{`${dayTime ? Math.round(day.temp.day) : Math.round(day.temp.night)}`}</span>
                                <span className="weatherunit">°</span>
                            </div>
                            <div className="dayinfo">
                                <div className="daytempinfo" id="top" style={{background: dayTime ? (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#E4E4E4' : '#F3F3F3') : (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#57718A' : '#72879C')}}><span className="information">{`${dayTime ? Math.round(day.feels_like.day) : Math.round(day.feels_like.night)}`}°</span></div>

                                <div className="daytempinfo" style={{background: dayTime ? (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#F3F3F3' : '#FAFAFA') : (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#72879C' : '#8FA1B1')}}>
                                    <span className="information">{`${!dayTime ? Math.round(day.temp.day) : Math.round(day.temp.night)}`}°</span>
                                </div>

                                <div className="daytempinfo" style={{background: dayTime ? (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#E4E4E4' : '#F3F3F3') : (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#57718A' : '#72879C')}}><span className="information">{Math.round(day.pop)}</span><span style={{fontSize: '14px',marginLeft: '5px'}}>%</span></div>
                                <div className="daytempinfo" style={{background: dayTime ? (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#F3F3F3' : '#FAFAFA') : (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#72879C' : '#8FA1B1')}}><span className="information">{Math.round(day.wind_speed*18/5)}</span><span style={{fontSize: '11px', marginTop: '4px',marginLeft: '5px'}}>{currentWindDirection(weatherData.current.wind_deg)}</span></div>
                                <div className="daytempinfo" style={{background: dayTime ? (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#E4E4E4' : '#F3F3F3') : (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#57718A' : '#72879C')}}><span className="information">{Math.round(day.wind_gust*18/5)} </span></div>
                                <div className="daytempinfo" style={{background: dayTime ? (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#F3F3F3' : '#FAFAFA') : (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#72879C' : '#8FA1B1')}}><span style={{fontSize: '13px',fontWeight: 'bold'}} className="information">{`${day.rain ? day.rain+' mm' : '-'}`}</span></div>
                                <div className="daytempinfo" style={{background: dayTime ? (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#E4E4E4' : '#F3F3F3') : (moment(date).format('dddd')==='Saturday' || moment(date).format('dddd')==='Sunday' ? '#57718A' : '#72879C')}}><span  style={{fontSize: '13px',fontWeight: 'bold'}} className="information">{`${day.snow ? day.snow+' mm' : '-'}`}</span></div>
                            </div>
                        </div>
